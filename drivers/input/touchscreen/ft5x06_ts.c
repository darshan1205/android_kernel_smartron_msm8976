...
static ssize_t ft5x06_ts_disable_keys_show(struct device *dev, struct device_attribute *attr, char *buf);

static ssize_t ft5x06_ts_disable_keys_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t count);
